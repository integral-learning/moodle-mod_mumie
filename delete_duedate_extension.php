...
require_capability('mod/mumie:revokeduedateextension', \core\context\system::instance());
$extension = mumie_duedate_extension::load_by_id($duedateid);
$extension->delete();
$calendarservice = new mumie_individual_calendar_service($extension->get_mumie(), $extension->get_userid());
