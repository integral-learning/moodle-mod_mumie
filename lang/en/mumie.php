...
$string['mumie_duration_property_hint'] = 'Deadline can only be applied to tasks that were previously created with the Working Period type \'Deadline\'.';
...
$string['mumie_form_task_no_deadline_warning'] = 'Working period: not Deadline';
$string['mumie_form_tasks_deadline_only'] = 'Only tasks with Working Period type \'Deadline\' are shown.';
